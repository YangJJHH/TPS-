...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void Move(Vector2 moveInput)
    {
        ...
        //현재 속도와 타겟속도를 비교해서 움직임을 부드럽게 damping하는과정, speedSmoothTime / airControlPercent 는 공중에서는 컨트롤이 잘 먹히지 않도록 설정
        ...
        currentVelocityY = characterController.isGrounded ? 0f : currentVelocityY; 
    }
    /// <summary>
    /// 카메라와 플레이어를 정렬하는 함수, 움직이거나 총을 쏘는경우 정렬함
    /// </summary>
    public void Rotate()
    {
