...
public class Gun : MonoBehaviour
{
    ...
    private void Shot(Vector3 startPoint, Vector3 direction)
    {
        ...
        if (Physics.Raycast(startPoint, direction, out hit, fireDistance, ~excludeTarget)) //excludeTarget을 제외한 레이어만 사격가능하게끔, ~은 비트를 뒤집는 연산자
        {
        ...
        {
            hitPosition = startPoint + fireDistance * direction;
        }
